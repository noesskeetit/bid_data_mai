DROP SCHEMA if exists source2 CASCADE;

CREATE SCHEMA source2;

DROP TABLE if exists source2.craft_market_masters_products;
...
DROP TABLE if exists source2.craft_market_orders_customers;
