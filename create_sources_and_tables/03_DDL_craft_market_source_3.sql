...
DROP TABLE if exists source3.craft_market_craftsmans;
...
DROP TABLE if exists source3.craft_market_customers;
...
DROP TABLE if exists source3.craft_market_orders;
